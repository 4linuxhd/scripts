...
cursos_funcionarios = LOAD '/user/hduser/dados/funcionarios.txt' USING PigStorage(',') AS (id_func:int, nome:chararray, cargo:chararray, salario:int, departamento:chararray);
...
STORE media_salario_departamento INTO '/user/hduser/pig_out/media_salarios_funcionarios' USING PigStorage(',');
